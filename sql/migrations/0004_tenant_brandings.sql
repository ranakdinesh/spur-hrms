-- Tenant-owned visual branding. Tenants are resolved by hrms.tenant_profiles.subdomain.
-- This migration also upgrades any earlier experimental tenant_brandings table.

CREATE TABLE IF NOT EXISTS hrms.tenant_brandings (
    tenant_id              UUID PRIMARY KEY REFERENCES auth.tenants(id) ON DELETE CASCADE,
    logo_path              TEXT,
    favicon_path           TEXT,
    layout                 VARCHAR(40) NOT NULL DEFAULT 'vertical',
    color_mode             VARCHAR(20) NOT NULL DEFAULT 'light',
    sidebar_size           VARCHAR(20) NOT NULL DEFAULT 'default',
    layout_width           VARCHAR(20) NOT NULL DEFAULT 'fluid',
    card_layout            VARCHAR(20) NOT NULL DEFAULT 'bordered',
    theme_color            VARCHAR(7) NOT NULL DEFAULT '#588368',
    primary_color          VARCHAR(7) NOT NULL DEFAULT '#588368',
    secondary_color        VARCHAR(7) NOT NULL DEFAULT '#2f6f7d',
    tertiary_color         VARCHAR(7) NOT NULL DEFAULT '#e87839',
    topbar_color           VARCHAR(7) NOT NULL DEFAULT '#ffffff',
    sidebar_color          VARCHAR(7) NOT NULL DEFAULT '#111827',
    topbar_background      TEXT NOT NULL DEFAULT 'none',
    sidebar_background     TEXT NOT NULL DEFAULT 'solid',
    font_family            VARCHAR(120) NOT NULL DEFAULT 'Inter, sans-serif',
    preloader              BOOLEAN NOT NULL DEFAULT TRUE,
